    ...
    string FallbackReason = "")
{
    ...
    /// This default is only the raw JSON entry: the <c>panel</c> route points at
    /// <c>{publisherUrl}/panel-app/</c>, and the 面板数据预览 card reads this document through
    /// <c>{publisherUrl}/panel.json</c>.
    /// </summary>
